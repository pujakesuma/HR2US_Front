...
import {
  ...
  faCommentDots,
  faSignOutAlt
} from "@fortawesome/free-solid-svg-icons"; //Styling Fontawesome
...
class Header extends Component {
  ...
  render() {
    let name;
    localStorage.getItem("role") === "engineer"
      ? (name = this.props.Engineers.user.split(" "))
      : (name = this.props.Companies.user.split(" ")); //split engineer
    ...
    return (
      <>
        <Navbar
          bg="light"
          expand="lg"
          style={{ borderBottom: "3px solid #DADADA" }}
        >
          {" "}
          ...
          <Navbar.Collapse className="ml-2" id="basic-navbar-nav">
            <Col md="6">
              {this.props.searchBar === "true" ? <Search /> : null}
            </Col>
            <Col>
              <Row>
                <Col md="5">
                  <Nav className="ml-auto">
                    ...
                    <hr
                      style={{
                        border: "none",
                        borderRight: "1px solid hsla(200, 10%, 50%, 100",
                        height: "4vh",
                        width: "1px"
                      }}
                    />{" "}
