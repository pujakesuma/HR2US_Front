...
class Profile extends Component {
  ...
  deleteData = () => {
    const url = `https://hr2us-app.herokuapp.com/api/engineers/${this.props.Profile.id}`;
    const config = {
      headers: {
              ...
              {!this.props.Profile.photo ? (
                ...
                <Card
                  style={{
                    ...
                    width: "14rem",
                    height: "20rem",
                    backgroundImage: `url(https://hr2us-app.herokuapp.com/uploads/engineers/${this.props.Profile.photo})`,
                    backgroundSize: "cover",
                    backgroundPosition: "center"
                  }}
                >
              ...
              <Table striped bordered hover>
                <tbody>
                  ...
                  <tr>
                    <td>Description</td>
                    <td>
                      {this.props.Profile.description !== null &&
                        this.props.Profile.description !== "null" &&
                  ...
                  <tr>
                    ...
                    <td>
                      <Numbering
                        value={this.props.Profile.expectedSalary}
                        displayType="text"
                        thousandSeparator
                        prefix="Rp. "
                      />
                  ...
                  <tr>
                    <td>Showcase</td>
                    <td>
                      {this.props.Profile.showcase !== null &&
                        this.props.Profile.showcase !== "null" &&
                        this.props.Profile.showcase}
                    </td>
                  </tr>
                </tbody>
              </Table>
