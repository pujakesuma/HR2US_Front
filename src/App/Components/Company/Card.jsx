...
class Card extends Component {
  componentDidMount() {
    this.fetchCompanies(
      "https://hr2us-app.herokuapp.com/api/companies/?page=1"
    );
  }
  ...
  render() {
    return (
      <>
              ...
              {["Primary"].map(variant => (
                ...
                >
                  <Dropdown.Item
                    ...
                    onClick={() =>
                      this.fetchCompanies(
                        this.props.Companies.base_url.replace(
                          /&limit=5|&limit=10|&limit=15|&limit=20/gi,
                          ""
                        ) + "&limit=5"
                      )
                    }
                ...
                >
                  <Dropdown.Item
                    ...
                    onClick={() =>
                      this.fetchCompanies(
                        this.props.Companies.base_url.replace(
                          /&sort=name&order=asc|&sort=name&order=desc/gi,
                          ""
                        ) + "&sort=name&order=asc"
                      )
                    }
        ...
        ) : this.props.Companies.dataTotal <= 0 ? (
          <Row className="justify-content-center">
            <p>No Data Found!</p>
          </Row>
        ) : (
        ...
        <Row className="justify-content-center">
          ...
          !this.props.Companies.previous ? (
            ...
            <Button
              variant="outline-primary"
              onClick={() => this.fetchCompanies(this.props.Companies.previous)}
            >
              {" "}
              Previous{" "}
            </Button>
          ...
          {!this.props.Companies.next ? (
            ...
            <Button
              variant="outline-primary"
              onClick={() => this.fetchCompanies(this.props.Companies.next)}
            >
              {" "}
              Next{" "}
            </Button>
