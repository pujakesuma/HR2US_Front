...
class EditProfile extends Component {
    ...
    Update = e => {
        ...
        const url = `http://localhost:5000/api/companies/${localStorage.getItem('id')}`
        ...
        return (
            ...
            <Container className="justify-content-center mt-3" style={{ paddingBottom:'20px'}}>
                <Row className='justify-content-center'>
                    <Col md='3'>
                        <Card style={{ marginBottom:'15px', marginRight: '20px', borderRadius:'12%', width: '14rem', height:'20rem', backgroundImage: `url(http://localhost:5000/uploads/companies/${this.state.logo})`,backgroundPosition:'center', backgroundSize: 'cover' }}>
