...
class CompanyProfile extends Component {
    ...
    componentDidMount(){
        this.companyProfile(`http://localhost:5000/api/companies/`+this.props.match.params.id)
    }
            ...
            <Container className='justify-content-center mt-3' style={{ paddingBottom:'20px'}}>
                <Row className='justify-content-center'>
                    <Col md='3'>
                        ...
                        <Card style={{ marginBottom:'15px', marginRight: '20px', borderRadius:'12%', width: '14rem', height:'20rem', backgroundImage: `url(http://localhost:5000/uploads/companies/${this.props.Companies.logo})`, backgroundPosition: 'center', backgroundSize: 'cover' }}>
                        <Card.Body style={{ height: '200px'}}>
                        </Card.Body>
                        </Card>
                    }
