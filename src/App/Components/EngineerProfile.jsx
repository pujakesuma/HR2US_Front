...
class EngineerProfile extends Component {
  componentDidMount() {
    this.engineerProfile(
      `https://hr2us-app.herokuapp.com/api/engineers/` +
              ...
              {!this.props.Engineers.photo ? (
                ...
                <Card
                  style={{
                    ...
                    width: "14rem",
                    height: "20rem",
                    backgroundImage: `url(https://hr2us-app.herokuapp.com/api/engineers/${this.props.Engineers.photo})`,
                    backgroundPosition: "center",
                    backgroundSize: "cover"
                  }}
                >
              ...
              <Table striped bordered hover>
                <tbody>
                  ...
                  <tr>
                    <td>Location</td>
                    <td>
                      {this.props.Engineers.location !== null &&
                        this.props.Engineers.location !== "null" &&
                        this.props.Engineers.location}
                    </td>
                  </tr>
                  <tr>
                    <td>Description</td>
                    <td>
                      {this.props.Engineers.description !== null &&
                        this.props.Engineers.description !== "null" &&
                        this.props.Engineers.description}
                    </td>
                  </tr>
                  <tr>
                    <td>Email</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Numbering
                        value={this.props.Engineers.expectedSalary}
                        displayType="text"
                        thousandSeparator
                        prefix="Rp. "
                      />
                  ...
                  <tr>
                    <td>Skill</td>
                    <td>
                      {this.props.Engineers.skill !== null &&
                        this.props.Engineers.skill !== "null" &&
                        this.props.Engineers.skill}
                    </td>
                  </tr>
                  <tr>
                    <td>Showcase</td>
                    <td>
                      {this.props.Engineers.showcase !== null &&
                        this.props.Engineers.showcase !== "null" &&
                        this.props.Engineers.showcase}
                    </td>
                  </tr>
                </tbody>
              </Table>
